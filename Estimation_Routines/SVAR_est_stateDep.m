function [IRF, BIC, ei, SSR, TSS, SE] = SVAR_est_stateDep(Y_raw, S_raw, settings, bias_corrected)
    % settings 
    ...
    for i_state = 0:1
        ...
        Y_sub = Y_raw(idx,:);
        % g
        [IRF_g_tmp, BIC_g_tmp, ei_g_tmp, SSR_g_tmp,TSS_g_tmp, SE_g_tmp] ...
            = SVAR_est(Y_sub, settings, respV.g,recurShock, normalizeV, bias_corrected);
        ...
        % y
        [IRF_y_tmp, BIC_y_tmp, ei_y_tmp, SSR_y_tmp,TSS_y_tmp, SE_y_tmp] ...
            = SVAR_est(Y_sub, settings, respV.y,recurShock, normalizeV, bias_corrected);
